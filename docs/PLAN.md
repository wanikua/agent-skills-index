...
4. 标注说明：
   ...
   - **⚠️D#**：依赖第 2 节的决策点。D1–D7 已于 2026-09-24 由 owner 确认，全部按“默认”列执行，无需再询问。
...
> **2026-09-24 owner 确认：D1–D7 全部采用下表“决定”列（即原推荐默认值）。** 如需变更，由 owner 修改本表并注明日期。

| ID | 问题 | 选项 | 决定（= 推荐默认，已确认） | 理由 |
|---|---|---|---|---|
